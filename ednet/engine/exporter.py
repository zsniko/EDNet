...
from ednet.cfg import TASK2DATA, get_cfg
from ednet.data import build_dataloader
from ednet.data.dataset import YOLODataset
from ednet.data.utils import check_cls_dataset, check_det_dataset
from ednet.nn.autobackend import check_class_names, default_class_names
from ednet.nn.modules import C2f, Detect
from ednet.nn.tasks import DetectionModel, SegmentationModel
...
from ednet.utils.checks import check_imgsz, check_is_path_safe, check_requirements, check_version
from ednet.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from ednet.utils.files import file_size, spaces_in_path
from ednet.utils.ops import Profile
from ednet.utils.torch_utils import TORCH_1_13, get_latest_opset, select_device, smart_inference_mode
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        description = f'EDNet {self.pretty_name} model {f"trained on {data}" if data else ""}'
        self.metadata = {
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        ...
        LOGGER.warning(f"{prefix} WARNING ⚠️ Edge TPU known bug issues 1185")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an YOLO model for Apple iOS CoreML export."""
