...
from ednet.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr

try:
    # WARNING: do not move SummaryWriter import due to protobuf bug
    ...
    from ednet.utils.torch_utils import de_parallel, torch
