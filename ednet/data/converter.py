...
from ednet.utils import LOGGER, TQDM
...
def convert_coco(
    ...
    Example:
        ```python
        from ednet.data.converter import convert_coco
...
def convert_segment_masks_to_yolo_seg(masks_dir, output_dir, classes):
    ...
    Example:
        ```python
        from ednet.data.converter import convert_segment_masks_to_yolo_seg
...
def convert_dota_to_yolo_obb(dota_root_path: str):
    ...
    Example:
        ```python
        from ednet.data.converter import convert_dota_to_yolo_obb
