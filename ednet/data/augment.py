...
from ednet.data.utils import polygons2masks, polygons2masks_overlap
from ednet.utils import LOGGER, colorstr
from ednet.utils.checks import check_version
from ednet.utils.instance import Instances
from ednet.utils.metrics import bbox_ioa
from ednet.utils.ops import segment2box, xyxyxyxy2xywhr
from ednet.utils.torch_utils import TORCHVISION_0_10, TORCHVISION_0_11, TORCHVISION_0_13
...
class Compose:
    ...
    def __init__(self, transforms):
        ...
        Examples:
            >>> from ednet.data.augment import Compose, RandomHSV, RandomFlip
...
class Mosaic(BaseMixTransform):
    ...
    Examples:
        >>> from ednet.data.augment import Mosaic
...
class MixUp(BaseMixTransform):
    ...
    Examples:
        >>> from ednet.data.augment import MixUp
        >>> dataset = YourDataset(...)  # Your image dataset
...
class RandomHSV:
    ...
    Examples:
        >>> import numpy as np
        >>> from ednet.data.augment import RandomHSV
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing the following keys:
                ...
                'instances' (ednet.utils.instance.Instances): An object containing bounding boxes and
                    optionally keypoints.

        Returns:
            (Dict): The same dictionary with the flipped image and updated instances:
                'img' (numpy.ndarray): The flipped image.
                'instances' (ednet.utils.instance.Instances): Updated instances matching the flipped image.
    ...
    def __call__(self, labels):
        ...
        Args:
            labels (Dict): A dictionary containing:
                ...
                - 'instances' (ednet.engine.results.Instances): Object containing bounding boxes, segments, etc.
...
class ToTensor:
    ...
    def __init__(self, half=False):
        ...
        framework. It converts numpy arrays or PIL Images to PyTorch tensors, with an option
