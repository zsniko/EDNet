...
from ednet.data.utils import FORMATS_HELP_MSG, IMG_FORMATS, VID_FORMATS
from ednet.utils import IS_COLAB, IS_KAGGLE, LOGGER, ops
...
def autocast_list(source):
    ...
    for im in source:
        if isinstance(im, (str, Path)):  # filename or uri
            ...
            raise TypeError(
                f"type {type(im).__name__} is not a supported prediction source type. \n"
            )
